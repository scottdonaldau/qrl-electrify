...
Scaffold.prototype.prepare = function() {
  ...
  //TODO: use  { electrify: this.$.env.version } or something different
  var electrifyVersion = 'file://';
  if (this.$.env.os.is_windows) {
    electrifyVersion += '/';
  }
  electrifyVersion += this.$.env.app.electrify_path;
  ...
  if (!fs.existsSync(package)) {
    fs.writeFileSync(package, JSON.stringify({
      ...
      main: 'index.js',
      dependencies: { electrify: electrifyVersion }
    }, null, 2));
  }
