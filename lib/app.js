...
App.prototype.ensure_deps = function(done) {
  ...
  if(this.$.env.is_development_mode) {
    ...
    //copy current node_modules folder (TODO: change after creating real npm package)
    // shell.cp('-r', join(this.$.env.app.electrify_path, 'node_modules'), this.$.env.app.root);
